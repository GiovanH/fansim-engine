...
image bg background1 = Image("{{assets}}/bg/background1.png")
image bg background2 = Image("{{assets}}/bg/background2.png")
image bg background3 = Image("{{assets}}/bg/background3.png")
image bg background4 = Image("{{assets}}/bg/background4.png")

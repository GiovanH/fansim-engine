screen main_menu():
    ...
    imagebutton auto "assets_custom/start_%s.png" action Start("start_custom") pos (20, 285) at menumove
    imagebutton auto "gui/start_%s.png" action Start("start") pos (20, 345) at menumove

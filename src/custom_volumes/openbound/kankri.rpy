define ob_kankri = Character("kankri", kind=trollean, what_color="#000000", image="ob_kankri", window_background="gui/textbox_trollian_rust.png")
...
image ob_kankri talk4 = Image("{{assets}}/dialogs/kankri/kankri_talk4.png", yoffset=-197, xanchor=240, yalign=1.0)
image ob_kankri talk = Image("{{assets}}/dialogs/kankri/kankri_talk.png", yoffset=-197, xanchor=240, yalign=1.0)
image ob_kankri whistle = Image("{{assets}}/dialogs/kankri/kankri_whistle.png", yoffset=-197, xanchor=240, yalign=1.0)
...
image ob_kankri talk:
    ...
    pause 0.1
    repeat
image ob_kankri whistle:
    Image("{{assets}}/dialogs/kankri/kankri_whistle-0.png", yoffset=-197, xanchor=240, yalign=1.0)
    pause 0.1
